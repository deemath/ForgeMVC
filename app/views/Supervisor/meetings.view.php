        ...
        <div class="flex flex-col md:flex-row">
            <div class="form-container bg-white p-6 rounded-lg shadow-md flex-1 mb-6 md:mb-0 md:mr-6">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" id="meeting-title" placeholder="Enter meeting title" class="w-full p-2 border border-gray-300 rounded">
                </div>
                <div class="form-group mb-4">
                    <label for="meeting-date" class="block text-gray-700 mb-2">Meeting Date</label>
                    <div class="relative">
                        <input type="text" id="meeting-date" placeholder="dd/mm/yyyy" class="w-full p-2 border border-gray-300 rounded pr-10">
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="relative">
                        <input type="text" id="meeting-time" placeholder="--:--" class="w-full p-2 border border-gray-300 rounded pr-10">
                        <i class="fas fa-clock absolute right-3 top-3 text-gray-500"></i>
                    </div>
                </div>
                <div class="form-group mb-4">
                    <label for="meeting-description" class="block text-gray-700 mb-2">Meeting Description</label>
                    <textarea id="meeting-description" rows="4" placeholder="Enter meeting description" class="w-full p-2 border border-gray-300 rounded"></textarea>
                </div>
                <div class="form-group mb-4">
                    <label for="meeting-members" class="block text-gray-700 mb-2">Meeting Members</label>
                    <input type="text" id="meeting-members" placeholder="Enter meeting members" class="w-full p-2 border border-gray-300 rounded">
                </div>
                <a href="#" class="bg-blue-800 text-white py-2 px-4 rounded inline-block text-center">+ Create</a>
            </div>
            <div class="upcoming-meetings bg-white p-6 rounded-lg shadow-md flex-1">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div class="meeting-item bg-gray-50 p-4 rounded-lg shadow">
                        <h4 class="text-lg font-semibold text-gray-800 mb-2">Project Kickoff</h4>
                        <p class="text-gray-600 mb-1"><i class="fas fa-calendar-alt mr-2"></i>Date: 2023-10-15</p>
                        <p class="text-gray-600 mb-1"><i class="fas fa-clock mr-2"></i>Time: 10:00 AM</p>
                        <p class="text-gray-600 mb-1"><i class="fas fa-user mr-2"></i>Created by: John Doe (Supervisor)</p>
                        <p class="text-gray-600 mb-1"><i class="fas fa-link mr-2"></i>Meeting Link: <a href="#" class="text-blue-600 underline">https://example.com/meeting1</a></p>
                        <button class="bg-blue-800 text-white py-1 px-3 rounded mt-2" onclick="copyToClipboard('https://example.com/meeting1')">Copy Link</button>
                    </div>
                    <div class="meeting-item bg-gray-50 p-4 rounded-lg shadow">
