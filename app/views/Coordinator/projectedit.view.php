            ...
            <div class="bg-white p-8 border border-gray-300 rounded-lg shadow-lg">
                ...
                <form method="post" action="<?=ROOT?>/Coordinator/updateProject">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="project-name" name="project-name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter project name" value="<?=$project->title?:''?>">
                    </div>
                    <div class="mb-6">
                        <label for="project-description" class="block text-gray-700 font-bold mb-2">Project Description</label>
                        <textarea id="project-description" name="project-description" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter project description"><?=$project->description?:''?></textarea>
                    </div>
                    <div class="mb-6">
                        <label for="start-date" class="block text-gray-700 font-bold mb-2">Start Date</label>
                        <input type="date" id="start-date" name="start-date" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"  value="<?=$project->startdate?:''?>">
                    </div>
                    <div class="mb-6">
                        <label for="end-date" class="block text-gray-700 font-bold mb-2">End Date</label>
                        <input type="date" id="end-date" name="end-date" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"  value="<?=$project->enddate?:''?>">
                    </div>
                    <div class="flex justify-end">
                        <button type="submit" class="bg-blue-500 text-white px-6 py-2 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">Submit</button>
                    </div>
                </form>
            </div>
...
<!--Add supervisors -->
                ...
                <form method="POST" action="<?=ROOT?>/Coordinator/addSup/<?=$data['project']->id?>">
                    ...
                    <div class="flex">
                        ...
                        <button type="submit" class="bg-green-500 text-white px-4 py-2 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500">
                            Add
                        </button>
                    </div>
                </form>
