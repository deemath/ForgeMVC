...
class task {
    ...
    public function updatetask(){
        ...
        if (isset($_POST['startdate'])) {
            $data['startdate'] = htmlspecialchars($_POST['startdate']);
        }
        if (isset($_POST['enddate'])) {
            $data['enddate'] = htmlspecialchars($_POST['enddate']);
        }
    ...
    public function createtask(){
        ...
        $basicData['title'] = htmlspecialchars($title);
        $basicData['no'] = $no;
        $basicData['description'] = htmlspecialchars($description);
        $basicData['startdate'] = htmlspecialchars($startDate);
        $basicData['enddate'] = htmlspecialchars($endDate);
